...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pxloader__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pxloader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_pxloader__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_pxloader_PxLoaderImage_js__ = __webpack_require__(10);
...
(function ($) {
    ...
    var Sage = {
        ...
        common: {
            ...
            handleCookiesAcceptance: function handleCookiesAcceptance() {
        ...
        welcome: {
            ...
            fadeOutWhiteWrapper: function fadeOutWhiteWrapper() {
                console.log('=> app.welcome.fadeOutWhiteWrapper()');
                $('#white-wrapper').fadeOut(1200);
            },
            loadImagesBeforeShowing: function loadImagesBeforeShowing() {
                var _this = this;
                ...
                var loader = new __WEBPACK_IMPORTED_MODULE_0_pxloader___default.a();
                loader.addImage('/images/favicon.ico');

                //* Callback that will be run once images are ready
                loader.addCompletionListener(function () {
                    _this.fadeOutWhiteWrapper();
                });
    ...
    var UTIL = {
        fire: function fire(func, funcname, args) {
            var fire = void 0;
            var namespace = Sage;
            var name = funcname === undefined ? 'init' : funcname;
...
(function(root, factory) {
    if (true) {
        // AMD. Register as an anonymous module.
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function(PxLoader) {
